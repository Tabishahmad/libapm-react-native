...
const TrackerScreen = () => {
    ...
    return (<View style={styles.screen}>
      ...
      <View style={styles.card}>
        {cases ? (<>
            <ProfiledStatistic title="Confirmed" count={cases.TotalConfirmed} textColor="#C83852"/>
            <ProfiledStatistic title="Deaths" count={cases.TotalDeaths} textColor="#362D59"/>
            <ProfiledStatistic title="Recovered" count={cases.TotalRecovered} textColor="#69C289"/>
