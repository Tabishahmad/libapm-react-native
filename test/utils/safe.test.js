...
describe('safe', () => {
    ...
    describe('safeTracesSampler', () => {
        test('calls given function with correct args', () => {
            ...
            actualSafeFunction === null || actualSafeFunction === void 0 ? void 0 : actualSafeFunction({ transactionContext: { name: 'foo' } });
            expect(mockFn).toBeCalledTimes(1);
        ...
        test('calls given function amd return its result', () => {
            ...
            const actualSafeFunction = safeTracesSampler(mockFn);
            const actualResult = actualSafeFunction === null || actualSafeFunction === void 0 ? void 0 : actualSafeFunction({ transactionContext: { name: 'foo' } });
            expect(mockFn).toBeCalledTimes(1);
