...
describe('merge Hermes and Native profiles - addNativeProfileToHermesProfile', () => {
    it('should prefer Hermes meta data over Native', () => {
        expect(addNativeProfileToHermesProfile(createMockMinimalValidHermesProfileEvent(), createMockMinimalValidAppleProfile())).toEqual({
            platform: 'javascript',
            version: '1',
            transaction: {
    ...
    it('should keep only Hermes if Native has the same thread id', () => {
        ...
        expect(addNativeProfileToHermesProfile(createMockMinimalValidHermesProfileEvent(), Object.assign(Object.assign({}, appleProfilingEvent), { profile: Object.assign(Object.assign({}, appleProfilingEvent.profile), { samples: appleProfilingEvent.profile.samples.map(sample => (Object.assign(Object.assign({}, sample), { thread_id: '123' }))), thread_metadata: {
                    '123': {
                        name: 'JavaScriptThread',
                        priority: 1,
                    },
