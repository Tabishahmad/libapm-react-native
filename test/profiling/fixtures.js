 ...
 */
export function createMockMinimalValidHermesProfile() {
    return {
        samples: [
            {
                cpu: '-1',
 ...
 * */
export function createMockMinimalValidHermesProfileEvent() {
    return {
        platform: 'javascript',
        version: '1',
        transaction: {
 ...
 */
export function createMockMinimalValidAppleProfile() {
    return {
        debug_meta: {
            images: [
                {
