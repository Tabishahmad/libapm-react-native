...
describe('convert hermes profile to sentry profile', () => {
    it('simple test profile', () => __awaiter(void 0, void 0, void 0, function* () {
        const hermesProfile = {
            traceEvents: [],
            samples: [
                {
    ...
    describe('converts profile samples', () => {
        it('removes samples that are over the max duration of profile', () => {
            ...
            const hermesSamples = [
                Object.assign(Object.assign({}, getMinimumHermesSample()), { ts: '1' }),
                Object.assign(Object.assign({}, getMinimumHermesSample()), { ts: '3' }),
            ];
            const expectedSentrySamples = [
                Object.assign(Object.assign({}, getMinimumSentrySample()), { elapsed_since_start_ns: '0' }),
            ];
        ...
        it('removes samples that are equal the max duration of profile', () => {
            ...
            const hermesSamples = [
                Object.assign(Object.assign({}, getMinimumHermesSample()), { ts: '1' }),
                Object.assign(Object.assign({}, getMinimumHermesSample()), { ts: '2' }),
            ];
            const expectedSentrySamples = [
                Object.assign(Object.assign({}, getMinimumSentrySample()), { elapsed_since_start_ns: '0' }),
            ];
        ...
        function getMinimumHermesSample() {
            return {
                cpu: '-1',
                name: '',
                ts: '1',
        ...
        function getMinimumSentrySample() {
            return {
                elapsed_since_start_ns: '0',
                stack_id: 4,
                thread_id: '14509472',
