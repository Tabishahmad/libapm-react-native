...
describe('RewriteFrames', () => {
    ...
    const exceptionFromError = (options) => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b;
        const error = new Error(options.message);
        error.stack = options.stack;
        const event = yield eventFromException(defaultStackParser, error, HINT, ATTACH_STACKTRACE);
        createReactNativeRewriteFrames().process(event);
        const exception = (_b = (_a = event.exception) === null || _a === void 0 ? void 0 : _a.values) === null || _b === void 0 ? void 0 : _b[0];
        return exception;
    });
    beforeEach(() => {
    ...
    it('should not change cocoa frames', () => __awaiter(void 0, void 0, void 0, function* () {
        var _c, _d;
        ...
        const SENTRY_COCOA_EXCEPTION_EVENT = {
            exception: {
        ...
        expect((_d = (_c = event.exception) === null || _c === void 0 ? void 0 : _c.values) === null || _d === void 0 ? void 0 : _d[0]).toEqual(EXPECTED_SENTRY_COCOA_EXCEPTION);
    }));
    it('should not change jvm frames', () => __awaiter(void 0, void 0, void 0, function* () {
        var _e, _f;
        ...
        const SENTRY_JVM_EXCEPTION_EVENT = {
            exception: {
        ...
        expect((_f = (_e = event.exception) === null || _e === void 0 ? void 0 : _e.values) === null || _f === void 0 ? void 0 : _f[0]).toEqual(EXPECTED_SENTRY_JVM_EXCEPTION);
    }));
    it('should parse exceptions for react-native-v8', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const exception = yield exceptionFromError(REACT_NATIVE_V8_EXCEPTION);
    ...
    it('should parse exceptions for react-native Expo bundles on ios', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const exception = yield exceptionFromError(REACT_NATIVE_EXPO_EXCEPTION);
        expect(exception).toEqual({
    ...
    it('should parse exceptions for react-native Expo bundles on android', () => __awaiter(void 0, void 0, void 0, function* () {
        mockFunction(isExpo).mockReturnValue(true);
        Platform.OS = 'android';
        const REACT_NATIVE_EXPO_EXCEPTION = {
            message: 'Test Error Expo',
    ...
    it('should parse React Native errors on Android', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const exception = yield exceptionFromError(ANDROID_REACT_NATIVE);
        expect(exception).toEqual({
            value: 'Error: test',
            type: 'Error',
            mechanism: {
    ...
    it('should parse React Native errors on Android Production', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const exception = yield exceptionFromError(ANDROID_REACT_NATIVE_PROD);
        expect(exception).toEqual({
            value: 'Error: test',
            type: 'Error',
            mechanism: {
    ...
    it('should parse React Native errors on Android Hermes', () => __awaiter(void 0, void 0, void 0, function* () {
        mockFunction(isHermesEnabled).mockReturnValue(true);
        const ANDROID_REACT_NATIVE_HERMES = {
            message: 'Error: lets throw!',
            name: 'Error',
            stack: 'at onPress (address at index.android.bundle:1:452701)\n' +
        ...
        const exception = yield exceptionFromError(ANDROID_REACT_NATIVE_HERMES);
        expect(exception).toEqual({
